...
final class LevelsProvider {
    ...
    init() {
        ...
        levels.append(Level(numberOfHands: 2,
            chipsToUnlock: 0,
            chipsPerWin: 1,
        ...
        levels.append(Level(numberOfHands: 3,
            chipsToUnlock: 2,
            chipsPerWin: 2,
            winsInRowToDoubleChips: 10,
        ...
        levels.append(Level(numberOfHands: 4,
            chipsToUnlock: 250,
            chipsPerWin: 10,
            winsInRowToDoubleChips: 10,
        ...
        levels.append(Level(numberOfHands: 5,
            chipsToUnlock: 1000,
            chipsPerWin: 50,
            winsInRowToDoubleChips: 10,
        ...
        levels.append(Level(numberOfHands: 6,
            chipsToUnlock: 5000,
            chipsPerWin: 250,
            winsInRowToDoubleChips: 10,
        ...
        levels.append(Level(numberOfHands: 7,
            chipsToUnlock: 25000,
            chipsPerWin: 1000,
            winsInRowToDoubleChips: 10,
        ...
        levels.append(Level(numberOfHands: 8,
